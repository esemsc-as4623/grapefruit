 ...
 * Price Service
 *
 * Centralized service for fetching prices from amazon_catalog table (mock Amazon API)
 *
 * Architecture:
 * - Single source of truth: amazon_catalog table
 * - Graceful fallback chain for missing items
 * - Fuzzy matching for inventory name → catalog matching
 ...
 *
 * Fallback chain:
 * 1. Exact match in amazon_catalog (best)
 * 2. Fuzzy match in amazon_catalog (confidence > 0.7)
 * 3. Default price $5.99 (last resort)
 *
